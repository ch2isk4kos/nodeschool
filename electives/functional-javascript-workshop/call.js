/*
  JavaScript implements 'duck' typing. Duck typing is a style of dynamic typing in which an object's methods
  and properties determine the valid semantics, rather than its inheritance from a particular class
  ...
  In JavaScript, in order to write robust programs we sometimes need
  to check an object conforms to the type that we need.
  ...
  if we call it with the this value set to something that 'looks like an object'.
...
module.exports = function duckCount() {
  ...
  let quacks = arr.reduce(
    (prev, curr) => (isQuack.call(curr, "quack") ? prev + 1 : prev),
    0
  );
  return quacks;
};
