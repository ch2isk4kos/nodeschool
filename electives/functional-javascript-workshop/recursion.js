...
/*
  Recursion is a fundamental programming concept which can lead to elegant and 
  efficient solutions to algorithmic problems. In fact, recursion is so powerful,
  ...
  this recursive function will take an array of words, and return an array of those words, uppercased.
...
The point of this exercise is to familiarise yourself with recursion by
implementinga familiar interface using a recursive function.
...
to execute our solution to the previous basic_reduce problem.
...
// IIFE SOLUTION
// module.exports = function reduceIIFE(arr, fn, initial) {
