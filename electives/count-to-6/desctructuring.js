/*
  ...
  A slightly different syntax is needed in order to assign cell values to object properties,
  ...
  Let's assume that we need to extract certain pieces of information concerning a user from an input array, 
  ...
  Your task is to extract information about the username and email
  to a separate object containing two properties - username and email - and log it out.
...
console.log(data); // { username: user1, email: user1@gmail.com }
