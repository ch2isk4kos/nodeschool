/*
  ...
  Just like the spread operator helps us get rid of .apply, rest parameters help us get rid of
  ...
  This exercise uses a slightly different format than usual. This time, your goal is to write
  a Node module whose default export is an average function.
  
  You don't need to print anything to the console.
  
  That is, your solution should look something like:
  ...
  e.g. average(1, 2, 3) and average(5, 10), and making sure that it works in all cases.
